  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new Noegletal.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new Noegletal.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<Noegletal.Data.NoegleTalContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("NoegleTalConnection"));
      });
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<Noegletal.Models.NoegleTal.NoegleTalReport>("NoegleTalReports");

          this.OnConfigureOData(oDataBuilder);

          var model = oDataBuilder.GetEdmModel();

          builder.MapODataServiceRoute("odata/NoegleTal", "odata/NoegleTal", model);
